...
- **Base URL Backend (Chính thức):** `https://educhatbot-35971955178.europe-west1.run.app`
...
const sendChatMessage = async (sessionId, question) => {
  ...
  try {
    const response = await fetch(`https://educhatbot-35971955178.europe-west1.run.app/api/chat/sessions/${sessionId}/messages`, {
      method: "POST",
      headers: {
